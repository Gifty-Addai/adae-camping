...
const PaginationLink = ({
  ...
  <button
    ...
    className={cn(
      ...
      "cursor-pointer disabled:opacity-50 disabled:pointer-events-none hover:bg-[#8b7355] select-none",
      isActive && "bg-gray-900 text-white border-[#8b7355]  hover:text-white",
      className
    )}
    {...props}
  />
...
export const Pagination: React.FC<PaginationProps> = ({
  ...
  return (
    <PaginationRoot className="mt-3 mb-9">
      <PaginationContent>
        {/* Previous Button */}
        <PaginationItem>
          <PaginationPrevious
