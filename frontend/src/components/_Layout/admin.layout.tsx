...
export default function AdminLayout() {
  return (
    <SidebarProvider>
      <AppSidebar />
      <SidebarInset>
        <header className="flex h-16 shrink-0 z-50 items-center gap-2 transition-[width,height] ease-linear fixed group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
