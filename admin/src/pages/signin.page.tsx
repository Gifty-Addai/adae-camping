...
const SignInPage = () => {
  ...
  return (
    <Page
      pageTitle="Sign In"
      renderBody={() => (
        <div className="max-w-md mx-auto p-6 bg-card rounded-lg shadow-md mt-16 border border-border">
          <h2 className="text-center text-xl font-semibold text-card-foreground">Admin Sign In</h2>
          <p className="text-center text-sm text-card-foreground mb-4">Sign in to your admin account to continue</p>
